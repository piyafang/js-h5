(function () {
    ...
    var c_ntsdata = [
        ...
        'qunar.com|qunar.com||',
        '360cn|so.360.cn||',
        //zhouyue add at 2015/01/07
        'haosou.com|haosou.com||'
    ];
    //自然搜索
    //zhouyue add 'www.haosou.com|5376|130860' at 2015/01/07
    ...
    'cn.bing.com|4902|130727', 'www.lvping.com|5377|130999','www.haosou.com|5376|130860'];
    //#C
    ...
    var ss_data_other = ['baidu.com|4897|135366', 'google|4899|135371', 'soso.com|4900|135374', 'sogou.com|4901|135376',
     'bing.com|4902|135379', 'yahoo|4903|135383', 'so.com|5376|135390', '2345.com|1119|439101','haosou.com|5376|135390'];
            ...
            if (pageurl.indexOf("sid") >= 0 && pageurl.indexOf("allianceid") >= 0) {
                ...
                if (ref.indexOf("qq.com") >= 0) {
                    ...
                    if (ref.indexOf("123.sogou.com") >= 0) {
                        ...
                        //zhouyue at haosou.com at 2015/01/07
                        if (ref.indexOf("www.baidu.com") >= 0 || ref.indexOf("www.google.cn") >= 0 || ref.indexOf("www.google.com.hk") >= 0 || ref.indexOf("www.soso.com") >= 0 || ref.indexOf("www.bing.com") >= 0 || ref.indexOf("www.yahoo.cn") >= 0 || ref.indexOf("www.sogou.com") >= 0 || ref.indexOf("so.360.cn") >= 0 || ref.indexOf("so.com") >= 0 || ref.indexOf("haosou.com") >= 0) {
...
/*(function () {
    ...
    function open_ad_ie(url) {
        var width = window.screen.width; //屏幕分辨率的高
        var height = window.screen.height; //屏幕分辨率的宽
